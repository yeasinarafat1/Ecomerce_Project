...
const Footer = () => {
  return (
    <div className="flex items-center justify-center gap-7 w-full md:h-[432px] bg-[#191C1F]">
      <div className="flex flex-col gap-5  h-[295px]">
        ...
        <div className="text-white text-[16px]">yachenarafath@gmail.com</div>
      </div>
      ...
      <div className="flex flex-col gap-4 h-[295px]">
        ...
        <div className="bg-[#303639] h-[69px] w-[175px] flex items-center justify-center gap-3 rounded-md">
            <Image src={'asset/icons/playStoreLogo.svg'} alt='playlogo' height={32} width={32} />
        ...
        <div className="bg-[#303639] h-[69px] w-[175px] flex items-center justify-center gap-3 rounded-md">
            <Image src={'asset/icons/appleAppStoreLogo.svg'} alt='playlogo' height={32} width={32} />
            <div className="flex flex-col gap-2 text-white">
                <p className='text-[11px]'>Get it Now</p>
