...
const BottomBar = () => {
  return (
    <div className="w-full flex justify-center items-center flex-wrap  md:gap-5 mt-2 border-0 border-b-[1px] border-gray-300">
      <Select>
        <SelectTrigger className="bg-[#F2F4F5] w-[145px] md:w-[154px] h-[48px] bg-transparent outline-none border-0 flex items-center justify-center active:outline-none">
      ...
      <div className="flex justify-center items-center gap-2">
        <Image
          ...
          alt="map logo"
        />
        <p className="text-gray-400 text-[11px] md:text-[16px]">Track Order</p>
      </div>
      <div className="flex justify-center items-center gap-2">
        <Image
          className="size-[16px] md:size-[24px]"
