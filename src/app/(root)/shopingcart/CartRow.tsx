  ...
  return (
    <TableRow>
      ...
      <TableCell className={cn("text-sm font-medium")}>
        <div className="border border-gray-100 flex items-center justify-center gap-2 text-base">
          <Minus
      ...
      <TableCell className=" w-[150px] h-full">
        <div className="flex-center gap-2">
          <p className="text-base text-gray-600">$ {price * quantity}</p>
