...
import { Delete, DeleteIcon, ShoppingCart, X } from 'lucide-react';
import Image from 'next/image';
import React from 'react'
interface props {
  whishListItem: whislistitem[];
}
const MobileWhishlists = ({whishListItem}:props) => {
  return (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col gap-1  text-sm ">
                      <p className="text-[#475156] line-clamp-2">{item.name}</p>
...
export default MobileWhishlists
